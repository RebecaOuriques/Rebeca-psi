...
function Servico() {
    ...
    return (
        ...
        <>
<div className="text-xl font-bold font-sans text-white p-2 md:pt-5 text-center xl:text-left">Serviços</div>
        ...
        <div key={index} className="flex flex-col gap-2 bg-cor4 border-1 rounded-md p-3 shadow-md">
          <div>
            <div className="h-12 rounded-full bg-primary/10 flex align-middle items-center justify-center mb-4 ">
              <service.icone className="w-18 h-18 flex justify-center text-center items-center align-middle text-cor1 " />
            </div>
            <div className="text-center font-semibold text-cor1 text-xl p-2">{service.titulo}</div>
