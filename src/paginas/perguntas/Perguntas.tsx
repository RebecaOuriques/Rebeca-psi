        ...
        <>
            ...
            <div className='flex justify-center my-4'>
                <input
                    ...
                    className="border border-gray-300 font-corpo rounded-full px-4 py-2 w-[90%] md:w-[60%] lg:w-[40%] text-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-cor3"
                >
                </input>
