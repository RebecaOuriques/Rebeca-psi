...
function Navbar() {
  ...
  return (
    <nav className="grid grid-flow-col justify-between px-4 lg:px-0 bg-cor1 border-gray-200 text-white fixed top-0 left-0 w-full z-50 shadow-lg">
      ...
      <div className={`py-2.5 md:flex md:items-center justify-items-center  md:justify-evenly w-[10vh] md:w-[45vh] lg:w-[60vh] xl:w-[90vh] font-corpo transition-transform duration-400 ${isOpen ? 'block' : 'hidden'} md:block`}>
        ...
        <div className='py-1 px-1 md:py-0'>
        ...
        <div className='py-1 md:py-0'>
          <a href="#como-posso-ajudar" onClick={(e) => handleLinkClick(e, 'como-posso-ajudar')} className="relative after:block after:h-[2px] after:w-0 after:bg-cor3 after:transition-all after:duration-300 hover:after:w-full text-white hover:text-cor3 hover:font-bold font-semibold text-lg">
            Serviços
          </a>
        </div>
        <div className='py-1 md:py-0'>
        ...
        <div className='py-1 md:py-0'>
          <a href="#reviews" onClick={(e) => handleLinkClick(e, 'reviews')} className="relative after:block after:h-[2px] after:w-0 after:bg-cor3 after:transition-all after:duration-300 hover:after:w-full text-white hover:text-cor3 hover:font-bold font-semibold text-lg">
            Avaliações
          </a>
        </div>
        {/* <div className='py-1 md:py-0'>
